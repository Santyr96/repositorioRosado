...
<header class="grid grid-cols-2 bg-gradient-to-r from-yellow-400 to-red-600 rounded-b-lg {{$class}}">
    ...
    <div id="admin" class="flex flex-wrap gap-2 justify-end lg:justify-end items-center pr-4">
        <div>
            <a id="notificationButton" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24">
        ...
        <div id="dropdown" class=" hidden absolute top-16 right-5 mt-1 w-48  border-2 stroke-gray-300 bg-white" >
            ...
            <div>
                <ul class="flex h-auto flex-col overflow-y-auto">
                    <li>
                        <a class="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-100" href="#">
                            <p>Hola</p>
                        </a>
                    </li>
                </ul>
        ...
        <div class="p-2 flex items-center">
            ...
            <x-image-rounded src="storage/images/default_user_avatar.webp" alt="Imagen" class="h-12 w-12">
            </x-image-rounded>
