<div id='modal' tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form name="avatarForm" action="" method="post" enctype="multipart/form-data" data-avatar="{{ route('profile.uploadAvatar') }}">
                @csrf
                <input class="w-full p-4" type="file" name="avatar" id="avatar-file" accept="image/*" >
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button id="submitFile" type="submit"
                        class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Subir
                        imagen</button>
