...
<div class="flex justify-center">
    <button id={{$id}} class= "flex items-center justify-center gap-2 px-2 z-30 py-3 bg-purple-600 rounded-md text-white relative font-semibold after:-z-20 after:absolute 
                    ...
                    hover:[text-shadow:2px_2px_2px_#fda4af] text-center {{$class ?? ''}}" type="submit" name={{$name}}>
    {{$message}}
</button>
</div>
